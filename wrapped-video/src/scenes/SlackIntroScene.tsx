...
type SlackIntroSceneProps = {
  channelName: string;
  year: number;
};

export const SlackIntroScene: React.FC<SlackIntroSceneProps> = ({channelName, year}) => {
    ...
    <AbsoluteFill style={{backgroundColor: '#0d0d1a'}}>
      ...
      >
        ...
        <div
          style={{
            marginTop: 60,
            transform: `translateY(${interpolate(channelProgress, [0, 1], [30, 0])}px)`,
